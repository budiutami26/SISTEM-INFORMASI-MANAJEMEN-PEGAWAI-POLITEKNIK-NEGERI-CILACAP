...
<html>
  ...
  <body>
    ...
    <section class="login-content">
      <div class="logo">
        <h1>Sistem Informasi Manajemen Kepegawaian PNC</h1>
      </div>
      <div class="login-box">
      ...
      <form class="login-form" method="POST" action="{{route('login.auth')}}">
        {{ csrf_field() }}
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="email" type="text" name="email" placeholder="Username" value="{{ old('login') }}" required autofocus>
            @if ($errors->has('login'))
